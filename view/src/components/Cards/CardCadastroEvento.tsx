    ...
    <div className="">
      <div className="bg-[#080809] p-4 rounded-lg border-l-1 border-[#A7AEFF]">
        <div className="flex justify-between">
          ...
          />
          <div className="text-right texto-small ml-2">
            {diasRestantes === 1 ? "Falta" : "Faltam"}
            <br />
        ...
        <div className="text-[#616EFF] text-[10px] text-right mt-10 pr-1">{evento.cdEvento}</div>
        <div className="text-white text-[12px] text-right mt-1 pr-1">
          eu quero participar!
        </div>
      </div>
