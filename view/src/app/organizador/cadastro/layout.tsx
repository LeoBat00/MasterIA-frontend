...
export default function OrganizadorCadastroLayout({
  children,
}: {
  ...
  return (
    <div className="flex min-h-screen bg-[#040405] text-white">
      ...
      <main className="flex-1">
        <div className="flex items-center justify-between border-b border-white/10 bg-[#040405] px-4 py-3 lg:hidden">
          <button
            type="button"
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden">
          <div className="h-full w-[18rem] max-w-[85vw] bg-[#040405]">
            <MenuLateral
              className="h-full w-full rounded-none border-r border-white/5"
